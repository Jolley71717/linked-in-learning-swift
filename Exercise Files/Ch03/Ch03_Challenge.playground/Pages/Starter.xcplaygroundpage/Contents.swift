 ...
 */
// 1
var shopItemsArray = ["bag", "sword", "bang"]
var shopItemsDictionary = ["bag": 20, "sword": 20, "bang": 5]
// 2
shopItemsArray.contains("gromple Porkins")

// 3
shopItemsArray.insert("gromple Porkins", at: 2)
// 4
var selectedItem = shopItemsArray[3]
// 5
var selectedItemPrice = shopItemsDictionary[selectedItem]
// 6
var fullArmorSet: Set<String> = ["helmet", "shield", "boots", "safety glasses"]
var currentArmorSet: Set<String> = ["boots", "safety glasses"]
// 7
fullArmorSet.subtract(currentArmorSet)
// 8
var armorPieceTuple = (name: "Hazmat Suit of Bewilderment", cost: 50, canEquip: true)
