 ...
 */
// Creating arrays
var levelDifficulty: [String] = ["Easy", "Moderate", "Veteran", "Nightmare", "TERRY NIPPS"]
var extrasyn1: Array<String> = Array<String>()
levelDifficulty.count
// Count and isEmpty
// Accessing array values
var mostDifficult = levelDifficulty.last
print("The hardest difficulty level is \(mostDifficult!)")
